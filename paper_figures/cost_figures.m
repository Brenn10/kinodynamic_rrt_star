clear all
clc
do_obstacle_course = false;
do_no_obstacles = false;
do_no_obstacles_2 = true;
do_window_2 = false;
do_window_3 = false;
line_width = 2;
font_size = 12;
...
%     subplot(2,1,2)
    ...
    plot(seq_costs(:,1),seq_costs(:,2),'LineWidth',line_width);
%     hold on;
%     plot(sim_costs(:,1),sim_costs(:,2),'LineWidth',line_width);
