...
disp("Running")
[T, parents,iteration_times,iteration_costs,iteration_goal_times] = rrt.run(sample_state, state_free, input_free, start3', goal3', display,iterations);
load trajectory.mat
save("RRT3times.mat",'iteration_times')
save("RRT3goalTimes.mat",'iteration_goal_times')
